...
#BASE_URL="https://query1.finance.yahoo.com/v7/finance/download/$SYMBOL/key-statistics?ltr=1"
#"https://query2.finance.yahoo.com/v10/finance/quoteSummary/{0}?formatted=true&lang=en-US&region=US&modules=summaryProfile%2CfinancialData%2CrecommendationTrend%2CupgradeDowngradeHistory%2Cearnings%2CdefaultKeyStatistics%2CcalendarEvents&corsDomain=finance.yahoo.com".format(ticker)
#BASE_URL="https://query2.finance.yahoo.com/v10/finance/quoteSummary/$SYMBOL?formatted=true&lang=en-US&region=US&modules=summaryProfile%2CfinancialData%2CrecommendationTrend%2CupgradeDowngradeHistory%2Cearnings%2CdefaultKeyStatistics%2CcalendarEvents&corsDomain=finance.yahoo.com"
BASE_URL="https://query2.finance.yahoo.com/v10/finance/quoteSummary/$SYMBOL?formatted=true&lang=en-US&region=US&modules=summaryProfile%2CfinancialData%2CdefaultKeyStatistics%2C&corsDomain=finance.yahoo.com"
log $BASE_URL
